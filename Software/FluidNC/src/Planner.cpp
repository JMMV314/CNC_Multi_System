...
bool plan_buffer_line(float* target, plan_line_data_t* pl_data) {
    ...
    if (!(block->motion.systemMotion)) {
        ...
        next_buffer_head  = plan_next_block_index(block_buffer_head);
            // Notify interested modules about the newly-submitted move. This is non-blocking.
            // The target positions are provided in the incoming 'target' array (millimeters).
            motion_event_post(target, n_axis);
